...
$sql = "SELECT wp_terms.*,wp_term_taxonomy.* FROM wp_terms LEFT JOIN wp_term_taxonomy ON wp_terms.term_id = wp_term_taxonomy.term_id WHERE wp_term_taxonomy.taxonomy = 'product_cat' AND wp_term_taxonomy.parent = '$parent' AND wp_terms.slug != 'uncategorized'";
...
while($row = $result->fetch_assoc()) {
	...
	$term_id=(int)$row['term_id'];
     ...
     $data[]= array('subcategory_id' => $term_id,'subcategory_name' => $row['name'],'subcategory_image' => $image_url );
