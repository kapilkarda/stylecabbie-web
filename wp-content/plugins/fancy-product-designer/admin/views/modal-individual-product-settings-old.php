<div class="fpd-admin-modal-wrapper" id="fpd-modal-individual-product-settings">

	<div class="fpd-admin-modal-dialog" style="width: 800px;">
		<a href="#" class="fpd-close-admin-modal">&times;</a>
		<h2><?php _e('Individual Product Settings', 'radykal'); ?></h2>
		<p class="description"><?php printf( __('Here you can set individual product designer settings for this product. That allows to use different settings from the <a href="%s">main settings</a>.', 'radykal'), esc_url_raw( admin_url('admin.php?page=fpd_settings') ) ); ?></p>
...
<div class="radykal-tabs">
	...
	<div class="radykal-tabs-content">
		...
		<div class="fpd-admin-modal-btns">
			<button class="button button-primary fpd-save-admin-modal"><?php _e('Set', 'radykal'); ?></button>
		</div>
	</div><!-- modal dialog -->
</div><!-- modal wrapper -->
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		...
		$('#fpd-change-settings').click(function(evt) {
			...
			fpdFillForm($modalWrapper, $('[name="fpd_product_settings"]').val());
