...
class RWMB_Media_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media','iqonic' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media','iqonic' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media','iqonic' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media','iqonic' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media','iqonic' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media','iqonic' ) ),
			'noTitle'            => _x( 'No Title', 'media','iqonic' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => _x( 'Select Files', 'media','iqonic' ),
			'uploadInstructions' => _x( 'Drop files here to upload', 'media','iqonic' )
		) );
	}
