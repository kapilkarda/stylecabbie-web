		...
		<div class="outer_form_table">
			...
			<section class="ac-container border-top">		
				...
				<div class="headig_label <?php if($wcast_enable_intransit_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">	
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_intransit_customizer_email::get_customizer_url('customer_intransit_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
				...
				<div class="headig_label <?php if($wcast_enable_returntosender_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_returntosender_customizer_email::get_customizer_url('customer_returntosender_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
				...
				<div class="headig_label <?php if($wcast_enable_availableforpickup_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">	
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_availableforpickup_customizer_email::get_customizer_url('customer_availableforpickup_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
				...
				<div class="headig_label <?php if($wcast_enable_outfordelivery_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_outfordelivery_customizer_email::get_customizer_url('customer_outfordelivery_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
				...
				<div class="delivered_shipment_label headig_label <?php if($wcast_enable_delivered_status_email == 1){ echo 'enable'; } else{ echo 'disable'; }?> <?php if($wcast_enable_delivered_email['enabled'] === 'yes' && get_option('wc_ast_status_delivered') == 1){ echo 'delivered_enabel'; } ?>">
					...
					<a class="edit_customizer_a button button-primary btn_ast2 <?php if($wcast_enable_delivered_email['enabled'] === 'yes' && get_option('wc_ast_status_delivered') == 1){ echo 'disabled_link'; }?>" href="<?php echo wcast_delivered_customizer_email::get_customizer_url('customer_delivered_status_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
				...
				<div class="headig_label <?php if($wcast_enable_failure_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_failure_customizer_email::get_customizer_url('customer_failure_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
		...
		<div class="outer_form_table">
			...
			<section class="ac-container border-top">				
				<div class="headig_label <?php if($wcast_enable_late_shipments_email == 1){ echo 'enable'; } else{ echo 'disable'; }?>">	
					...
					<a class="edit_customizer_a button button-primary btn_ast2" href="<?php echo wcast_late_shipments_customizer_email::get_customizer_url('admin_late_shipments_email','shipment-status-notifications') ?>"><?php _e('Edit', 'woocommerce'); ?></a>
