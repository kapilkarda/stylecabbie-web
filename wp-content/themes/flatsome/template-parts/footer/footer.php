	...
	{ 
		jQuery(document).ready(function ($) {
		    ...
		    $('a').click(function(){
		        ...
		        if($(this).attr('href')=='#nav-home' || $(this).attr('href')=='#nav-profile' || spl[3]== "cart" || $(this).attr('href')=='#' || $(this).attr('href')=='#0' || $(this).attr('href')=='#tab-additional_information' || $(this).attr('href')=='https://www.stylecabbie.com/my-account/' || $(this).attr('href')=='#tab-reviews' || $(this).attr('href')=='#tab-description' || $(this).attr('href')=='#quick-view'){
